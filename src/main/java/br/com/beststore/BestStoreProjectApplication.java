...
import br.com.beststore.domain.Pagamento;
import br.com.beststore.domain.PagamentoComBoleto;
import br.com.beststore.domain.PagamentoComCartao;
...
import br.com.beststore.repository.ItemPedidoRepository;
import br.com.beststore.repository.PagamentoRepository;
...
public class BestStoreProjectApplication implements CommandLineRunner {

	public static void main(String[] args) {
		SpringApplication.run(BestStoreProjectApplication.class, args);
	}
		...
		public void run (String...args) throws Exception {
			...
			Cliente cli1 = new Cliente(null, "Maria Silva", "nelio.cursos@gmail.com", "36378912377", null, TipoCliente.PESSOAFISICA);
			cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

			Cliente cli2 = new Cliente(null, "Ana Costa", "nelio.iftm@gmail.com", "31628382740", null, TipoCliente.PESSOAFISICA);
